...
\begin{aufgabe} (Maßintegral \& fast-überall Eigenschaften)
    \begin{enumerate}
        ...
        \item 
        Betrachte für $a,b \in \R$ mit $a < b$ den Maßraum $(\Omega, \mathcal{A}, \mu) = ([a,b], \mathcal{B}\cup [a,b], \lambda_{\mathcal{B}\cup [a,b]})$ und sei $f \in \mathcal{L}(\Omega, \mathcal{A}, \mu)$. 
