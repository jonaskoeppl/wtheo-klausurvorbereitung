...
\begin{aufgabe} (Messbare Funktionen)
    \begin{enumerate}
        ...
        \item 
        Für $n \in \N$ sei $X_n \in \mathcal{F}(\R, \mathcal{B})$. Beurteilen Sie ob es sich bei den Folgenden Mengen um Borelmengen handelt: 
        \begin{align*}
            A_1 :&= \{\omega \in \R : \{X_n(\omega): n \in \N \} \text{ liegt dicht in } \R \}, \\\
            A_2 :&= \{\omega \in \R : (X_n(\omega))_{n \in \N} \text{ konvergiert in } \R \}, \\\
            A_3 :&= \{\omega \in \R : \sup_{n \in \N} \lvert X_n \rvert \leq C \}, C > 0. 
        \end{align*}
        \item
